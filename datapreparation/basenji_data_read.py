...
from basenji_data_1 import ModelSeq
...
def main():
  ...
  if len(args) != 3:
    ...
    genome_cov_file = args[0]##targetbwfile
  ...
  # compute dimensions
  num_seqs = len(model_seqs) ##23179个样本
  seq_len_nt = model_seqs[0].end - model_seqs[0].start  ##131072
  ...
  for si in range(num_seqs):
    ...
    seq_cov_nt = seq_cov_nt[8192:-8192]##114688
    # exit()
